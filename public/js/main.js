...
var loadMessages = ["Spreading misinformation.", "Rewriting all of the code.", "Delaying Version 0.4.", "Getting ducks in a row.", "Increasing functionality by 19%.", "Making bad puns.", "Learning Javascript.", "Translating Latin.", "Temporarily reviewing accounts.", "Recoloring sprites.", "Hyping Elites.", "Leaking outdated information.", "Rebooting idea machine.", "Sourcing locally grown lettuce.", "Finding cute animal gifs.", "Introducing game breaking bugs.", "Lowering self esteem.", "Redesigning game...again.", "Deleting important files.", "2 + 2 = 4 - 1 = 3"];

function selectLoadMessage() {
  var randomNumber = Math.floor(Math.random() * loadMessages.length);
...
var loading_screen = pleaseWait({
  ...
  loadingHtml: "\n    <div class=\"loadingMessage\">".concat(selectLoadMessage(), "</div>\n    <div class=\"spinner\"></div>\n    ")
});
