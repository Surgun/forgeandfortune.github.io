...
const Notifications = {
    ...
    rewardInvFull() {
        $.toast({
            text: `Inventory is currently full.`, // Text that is to be shown in the toast
            heading: 'Cannot collect Mail', // Optional heading to be shown on the toast
            icon: 'error', // Type of toast icon
            showHideTransition: 'fade', // fade, slide or plain
            allowToastClose: true, // Boolean value true or false
            hideAfter: 3000, // false to make it sticky or number representing the miliseconds as time after which toast needs to be hidden
    ...
    cantAffordFuse() {
        $.toast({
            text: "You do not have enough gold.", // Text that is to be shown in the toast
            heading: 'Cannot Start Fuse', // Optional heading to be shown on the toast
            icon: 'error', // Type of toast icon
            showHideTransition: 'fade', // fade, slide or plain
            allowToastClose: true, // Boolean value true or false
            hideAfter: 3000, // false to make it sticky or number representing the miliseconds as time after which toast needs to be hidden
